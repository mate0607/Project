...
<div class="landing-v2">
    ...
    <section class="lv2-hero">
        ...
        <div class="lv2-hero-bg">
            <div class="lv2-bg-gradient"></div>
            <div class="lv2-bg-orb lv2-bg-orb-1"></div>
            <div class="lv2-bg-orb lv2-bg-orb-2"></div>
            <div class="lv2-bg-grid"></div>
        </div>

        <div class="lv2-hero-inner">
            {{-- Left: headline --}}
            <div class="lv2-hero-text">
                <span class="lv2-badge">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
                    Professzionális járműkezelés
                </span>
            ...
            <div class="lv2-hero-card">
                <div class="lv2-hero-card-glow"></div>
                @auth
                    <div class="lv2-card-icon">
                        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0a1 1 0 01-1-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 01-1 1m-2 0h2"/></svg>
                    </div>
                    <h2>Üdvözöljük!</h2>
                    <p class="lv2-card-sub">Lépjen be a kezelőfelületre</p>
                    <a href="{{ auth()->user()->role === 'admin' ? route('admin.dashboard') : route('user.dashboard') }}" class="lv2-btn lv2-btn-primary">
                        Dashboard megnyitása
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                    </a>
                @else
                    <div class="lv2-card-icon">
                        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                    </div>
                    <h2>Lépjen be</h2>
                    <p class="lv2-card-sub">Jelentkezzen be vagy hozzon létre fiókot</p>
                    <div class="lv2-card-actions">
                        <a href="{{ route('login') }}" class="lv2-btn lv2-btn-primary">
                            Bejelentkezés
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                        </a>
    ...
    {{-- ===== ACCENT DIVIDER ===== --}}
    <div class="lv2-divider">
        <div class="lv2-divider-line"></div>
    </div>

    {{-- ===== FEATURES GRID ===== --}}
    <section class="lv2-features">
        <div class="lv2-features-header">
            <h2>Mindent egy helyen</h2>
            <p>Átfogó megoldások a járműkezelés minden területére</p>
        </div>
        <div class="lv2-features-grid">
            <div class="lv2-feat-card">
                <div class="lv2-feat-icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M5 17h14M5 17a2 2 0 01-2-2V7a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2M5 17l-1 4h2l1-4m10 0l1 4h2l-1-4"/><circle cx="7.5" cy="11.5" r="1.5"/><circle cx="16.5" cy="11.5" r="1.5"/><path d="M5 7l2-3h10l2 3"/></svg>
                </div>
                <h3>Járműkezelés</h3>
