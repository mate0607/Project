...
<head>
    ...
    <style>
        ...
        .error-code {
            ...
            line-height: 1;
            background: linear-gradient(135deg, #5588ff 0%, #7aa8ff 50%, #3d6be6 100%);
        ...
        html.light-mode .error-icon {
            background: rgba(85, 136, 255, 0.07);
            color: #3d6be6;
        }
        @keyframes fadeInUp {
...
<body>
    ...
    <div class="error-page">
        ...
        <h2 class="error-title">Az oldal nem található</h2>
        <p class="error-desc">A keresett oldal nem létezik, vagy áthelyezésre került. Ellenőrizd az URL-t, vagy térj vissza a főoldalra.</p>
